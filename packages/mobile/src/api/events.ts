...
export type TimelineItem =
  | { kind: "message"; seq: number; author: string; role: "user" | "assistant"; content: string; attachments?: MessageAttachment[]; userSteer?: boolean; interrupted?: boolean; time: string }
